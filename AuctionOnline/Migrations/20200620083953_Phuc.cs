    ...
    public partial class Phuc : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2020, 6, 23, 15, 39, 52, 600, DateTimeKind.Local).AddTicks(1362), 2m, new DateTime(2020, 6, 20, 15, 39, 52, 598, DateTimeKind.Local).AddTicks(8028), 1, new DateTime(2020, 6, 20, 15, 39, 52, 600, DateTimeKind.Local).AddTicks(3196), "description 1", null, 7m, null, 5m, true, "product 1" },
                    { 2, 1, new DateTime(2020, 6, 23, 15, 39, 52, 600, DateTimeKind.Local).AddTicks(5908), 2m, new DateTime(2020, 6, 20, 15, 39, 52, 600, DateTimeKind.Local).AddTicks(5881), 1, new DateTime(2020, 6, 20, 15, 39, 52, 600, DateTimeKind.Local).AddTicks(5952), "description 2", null, 7m, null, 10m, true, "product 2" },
                    { 3, 1, new DateTime(2020, 6, 23, 15, 39, 52, 600, DateTimeKind.Local).AddTicks(5998), 2m, new DateTime(2020, 6, 20, 15, 39, 52, 600, DateTimeKind.Local).AddTicks(5997), 1, new DateTime(2020, 6, 20, 15, 39, 52, 600, DateTimeKind.Local).AddTicks(6001), "description 3", null, 7m, null, 15m, true, "product 3" }
                });
